...
def generate_carry_data(training_data_type="default", omega=0.0, seed=0):
    ...
    if training_data_type == "gaussian":
...
def generate_unit_data(training_data_type="default", omega=0.0, seed=0):
    x_data = jnp.array([[a, b] for a in range(10) for b in range(10)], dtype=jnp.float32)
